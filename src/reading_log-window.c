...
reading_log_window_class_init (ReadingLogWindowClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/com/github/andersonjwan/ReadingLog/reading_log-window.ui");
  gtk_widget_class_bind_template_child (widget_class, ReadingLogWindow, header_bar);
  gtk_widget_class_bind_template_child (widget_class, ReadingLogWindow, label);
}
